...
namespace MatrixOfCalculator.Forms
{
    public partial class MatrixCalculation : Form
    {
        public MatrixCalculation()
        {
            ...
            TransposeMatrix.Click += (s, e) => Matrix.destinationMatrix = Matrix.TransposeMatrix(Matrix.matrixOne);
            ...
            AdditionMatrix.Click += (s, e) => Matrix.destinationMatrix = Matrix.AdditionMatrix(Matrix.matrixOne, Matrix.matrixTwo);
            SubtractionMatrix.Click += (s, e) => Matrix.destinationMatrix = Matrix.SubstractionMatrix(Matrix.matrixOne, Matrix.matrixTwo);
            MultiplicateMatrix.Click += (s, e) => Matrix.destinationMatrix = Matrix.MultiplicateBothMatrix(Matrix.matrixOne, Matrix.matrixTwo);
            FindReverseMatrix.Click += (s, e) => Matrix.destinationMatrix = Matrix.ReverseMatrix(Matrix.matrixOne);

            Next.Click += (s, e) =>
            {
                UserInterface.ShowButton(Revert);
                MoveToNextPage();
            };
            Revert.Click += (s, e) => MoveToPreviousPage();

            CloseWindow.Click += (s, e) => Close();

            UserInterface.HideButton(Revert);
        ...
        private void InputDataBothMatrix()
        {
            if (sizeTwoOnTwo.Checked)
            {
        ...
        {
            UserInterface.ChangeButtonNext(Next, "Главная");
        ...
        {
            UserInterface.ChangeButtonNext(Next, "Далее →");
            UserInterface.HideButton(Revert);
