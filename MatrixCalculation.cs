...
namespace MatrixOfCalculator.Forms
{
    ...
    {
        private float[,] _matrixOne, _matrixTwo, _temp;
        ...
        private void bNext_Click(object sender, EventArgs e)
        {
            if (bCreateMatrix.BackColor == Color.FromArgb(192, 255, 192))
            {
                ...
                if (inAutomatic.Checked)
                {
                    if (sizeTwoOnTwo.Checked)
                    {
                        AutomaticsInputDataToMatrix.AutoInput(_matrixOne = new float[2, 2]);
                        WorkWithForms.SetForm(currentDesign: gHomeWindow, chooseDesign: gOperationMatrix);
                    }

                    if (sizeThreeToThree.Checked)
                    {
                        AutomaticsInputDataToMatrix.AutoInput(_matrixOne = new float[3, 3]);
                        WorkWithForms.SetForm(currentDesign: gHomeWindow, chooseDesign: gOperationMatrix);
                    }

                    if (sizeFourToFour.Checked)
                    {
                        AutomaticsInputDataToMatrix.AutoInput(_matrixOne = new float[4, 4]);
                        WorkWithForms.SetForm(currentDesign: gHomeWindow, chooseDesign: gOperationMatrix);
                    }
                }
            ...
            if (bCreateBothMatrix.BackColor == Color.FromArgb(192, 255, 192))
            {
                ...
                if (inAutomatic.Checked)
                {
                    ...
                    {
                        AutomaticsInputDataToMatrix.AutoInput(_matrixOne = new float[2, 2]);
                        AutomaticsInputDataToMatrix.AutoInput(_matrixTwo = new float[2, 2]);
                    ...
                    {
                        AutomaticsInputDataToMatrix.AutoInput(_matrixOne = new float[3, 3]);
                        AutomaticsInputDataToMatrix.AutoInput(_matrixTwo = new float[3, 3]);
                    ...
                    {
                        AutomaticsInputDataToMatrix.AutoInput(_matrixOne = new float[4, 4]);
                        AutomaticsInputDataToMatrix.AutoInput(_matrixTwo = new float[4, 4]);
        ...
        {
            _temp = OperationWithMatrix.MultiplicateNumberOnMatrix(_matrixOne, (byte)tInputField.Text.CheckIntOrDefault());
        ...
        private void bContinue_Click(object sender, EventArgs e)
        {
            if (bCreateMatrix.BackColor == Color.FromArgb(192, 255, 192))
            {
                OperationWithMatrix.HandleInput(_matrixOne = new float[2, 2], tInput1.Text.CheckIntOrDefault(), tInput2.Text.CheckIntOrDefault(),
            ...
            if (bCreateBothMatrix.BackColor == Color.FromArgb(192, 255, 192))
            {
                ...
                {
                    OperationWithMatrix.HandleInput(_matrixTwo = new float[2, 2], tInput1.Text.CheckIntOrDefault(), tInput2.Text.CheckIntOrDefault(),
                        tInput3.Text.CheckIntOrDefault(), tInput4.Text.CheckIntOrDefault());
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (bCreateMatrix.BackColor == Color.FromArgb(192, 255, 192))
            {
                OperationWithMatrix.HandleInput(_matrixOne = new float[3, 3], textBox1.Text.CheckIntOrDefault(), textBox2.Text.CheckIntOrDefault(), textBox3.Text.CheckIntOrDefault(),
            ...
            if (bCreateBothMatrix.BackColor == Color.FromArgb(192, 255, 192))
            {
                ...
                if (UtilityTools.CheckExistData(_matrixOne) != _matrixOne.Length)
                {
                    OperationWithMatrix.HandleInput(_matrixTwo = new float[3, 3], textBox1.Text.CheckIntOrDefault(), textBox2.Text.CheckIntOrDefault(), textBox3.Text.CheckIntOrDefault(),
                        textBox4.Text.CheckIntOrDefault(), textBox5.Text.CheckIntOrDefault(), textBox6.Text.CheckIntOrDefault(), textBox7.Text.CheckIntOrDefault(),
                        textBox8.Text.CheckIntOrDefault(), textBox9.Text.CheckIntOrDefault());
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (bCreateMatrix.BackColor == Color.FromArgb(192, 255, 192))
            {
                OperationWithMatrix.HandleInput(_matrixOne = new float[4, 4], textBox10.Text.CheckIntOrDefault(), textBox11.Text.CheckIntOrDefault(), textBox12.Text.CheckIntOrDefault(),
            ...
            if (bCreateBothMatrix.BackColor == Color.FromArgb(192, 255, 192))
            {
                ...
                if (UtilityTools.CheckExistData(_matrixOne) != _matrixOne.Length)
                {
                    OperationWithMatrix.HandleInput(_matrixTwo = new float[4, 4], textBox10.Text.CheckIntOrDefault(), textBox11.Text.CheckIntOrDefault(), textBox12.Text.CheckIntOrDefault(),
                        textBox13.Text.CheckIntOrDefault(), textBox14.Text.CheckIntOrDefault(), textBox15.Text.CheckIntOrDefault(), textBox16.Text.CheckIntOrDefault(),
                        textBox17.Text.CheckIntOrDefault(), textBox18.Text.CheckIntOrDefault(), textBox19.Text.CheckIntOrDefault(), textBox20.Text.CheckIntOrDefault(),
                        textBox21.Text.CheckIntOrDefault(), textBox22.Text.CheckIntOrDefault(), textBox23.Text.CheckIntOrDefault(), textBox24.Text.CheckIntOrDefault(),
                        textBox25.Text.CheckIntOrDefault());
